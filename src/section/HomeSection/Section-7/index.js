    ...
    <div className="row m-0 py-5 px-2 d-flex justify-content-center align-items-center">
      ...
      <div className="col-12 col-lg-6 ">
        ...
        <text className="Text-1" style={{ color: color.grey }}>
          Receive customized solutions that cover every aspect of your business.
          We won't leave you without seeing you win.
        </text>
        <ul className="p-0">
          <li className="py-1 row">
            ...
            >
              Maintenance services to guarantee efficient operations.
            </text>
          </li>
          <li className="py-1 row">
            <span className="col-1 col-sm-1 col-md-1 d-flex justify-content-center flex-column">
            ...
            <text
              ...
              style={{ color: color.grey }}
            >
              Client acquisition support for up to 1000 customers.
            </text>
          </li>
          <li className="py-1 row">
            <span className="col-1 col-sm-1 col-md-1 d-flex justify-content-center flex-column">
            ...
            <text
              ...
              style={{ color: color.grey }}
            >
              Customer and financial metric evaluation.
            </text>
          </li>
          <li className="py-1 row">
            <span className="col-1 col-sm-1 col-md-1 d-flex justify-content-center flex-column">
